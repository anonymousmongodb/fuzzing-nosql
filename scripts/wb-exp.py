...
#    CONFIGS.append(Config([], "EXP"))
    ...
    instrumentMR_MONGO_true = ParameterSetting("instrumentMR_MONGO",["true"])
    instrumentMR_MONGO_false = ParameterSetting("instrumentMR_MONGO",["false"])
    heuristicsForMongo_true = ParameterSetting("heuristicsForMongo",["true"])
    heuristicsForMongo_false = ParameterSetting("heuristicsForMongo",["false"])
    generateMongoData_true = ParameterSetting("generateMongoData",["true"])
    generateMongoData_false = ParameterSetting("generateMongoData",["false"])
    extractMongoExecutionInfo_true = ParameterSetting("extractMongoExecutionInfo",["true"])
    extractMongoExecutionInfo_false = ParameterSetting("extractMongoExecutionInfo",["false"])

    BASE = Config([instrumentMR_MONGO_false,extractMongoExecutionInfo_false,heuristicsForMongo_false,generateMongoData_false],"Base")
    INSERTION  = Config([instrumentMR_MONGO_true,extractMongoExecutionInfo_true,heuristicsForMongo_true,generateMongoData_true], "Mongo")

    CONFIGS.append(BASE)
    CONFIGS.append(INSERTION)
